...
const NavBar = () => {
  ...
  // Ferme le menu mobile lorsque l'écran est redimensionné à une largeur supérieure
  useEffect(() => {
    const handleResize = () => {
  ...
  return (
    ...
    >
      ...
      <div 
        className={`md:hidden fixed top-0 right-0 w-64 h-full bg-white shadow-lg transform transition-transform duration-300 ease-in-out z-50 ${
      ...
      {/* Zone transparente à gauche pour fermer le menu en appuyant à côté */}
      {isMenuOpen && (
        <div 
