...
const Hero = () => {
  ...
  return (
    <>
      ...
      <motion.div 
        ref={heroRef}
        className="flex flex-col items-center justify-center py-49 px-4 text-gray-800 relative overflow-hidden"
        initial={{ opacity: 0 }}
        animate={heroInView ? { opacity: 1 } : { opacity: 0 }}
        transition={{ duration: 1 }}
      >
        {/* Vidéo en arrière-plan */}
        <div className="absolute top-5 left-0 w-full h-full z-0 overflow-hidden  ">
